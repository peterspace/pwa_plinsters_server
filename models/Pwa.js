...
const pwaSchema = new mongoose.Schema(
  {
    ...
    domain: String, // example: https://www.plinsters.pro/install
    subDomain: String, //
    languages: [String],
    defaultLanguage: String,
    pixelId: String, // fb pixel id
    accessToken: String, // fb access token
    domainApp: String, // example: https://www.malaysia-app.plinsters.pro/install // website of the pwa
    domainLanding: String, // example: https://www.malaysia.plinsters.pro/install // website of the landing page
    keitaroDomain: String, // example //"https://privacy.plinsters.pro
    keitaroFirstCampaign: String, // example: "https://privacy.plinsters.pro/Zwhxxgqc"
    keitaroSecondCampaign: String, // example:https://privacy.plinsters.pro/JjRSKs // optional
    oneSignalApiKey: String, // example:os_v2_app_z7spz3q4avem... // optional
    oneSignalAppId: String, // example:cfe4fcee-1c05-48cb-990d... // optional
    marketerTag: String, // example:"sub_id_3=TRN"
    icon: {
      type: String,
      default:
    ...
    backgroundPhotoMobile: {
      type: String,
      default:
        "https://res.cloudinary.com/datkh2oxv/image/upload/v1736767958/dmt/background%201x/bg-mobile_dlti2j.svg",
    },
    backgroundPhotoDesktop: {
      type: String,
      default:
        "https://res.cloudinary.com/datkh2oxv/image/upload/v1736767958/dmt/background%201x/bg-desktop_cecfn0.svg",
    },
    appTitle: { type: String, default: "1xBet" },
    ...
    egypt: {
      arabic: {
        ...
        step1SafariDesktop: {
          ...
          instruction: {
            type: String,
            default: "انقر على 'مشاركة' في القائمة",
          },
        },
        step2SafariDesktop: {
          name: { type: String, default: "الخطوة 2" },
        ...
        step1ChromeMobile: {
          ...
          instruction: {
            type: String,
            default: 'اضغط على "مشاركة" في القائمة.',
          },
        },
        step2ChromeMobile: {
          name: { type: String, default: "الخطوة 2" },
        ...
        fourPointThree: { type: String, default: "4.8" },
        ...
        reviewObject: [
          {
            ...
            helpfulCount: { type: String, default: "" },
        ...
        newFeatures: { type: String, default: "إصلاحات الأخطاء" },
      ...
      english: {
        ...
        pressIcon: {
          type: String,
          default: "Tap this icon to launch the app on the home screen.",
        },
        step1ChromeDesktop: {
        ...
        step1ChromeMobile: {
          name: { type: String, default: "Step 1" },
          instruction: { type: String, default: "Tap ‘Share’ on the menu" },
        },
        step2ChromeMobile: {
          name: { type: String, default: "Step 2" },
          instruction: { type: String, default: "Tap ‘Add to Home Screen’" },
        },
        step3ChromeMobile: {
          name: { type: String, default: "Step 3" },
          instruction: { type: String, default: "Tap ‘Add’" },
        },
        step1SafariMobile: {
          name: { type: String, default: "Step 1" },
          instruction: { type: String, default: "Tap ‘Share’ on the menu" },
        ...
        newFeatures: { type: String, default: "Bug fixes" },
    ...
    germany: {
      dutch: {
        ...
        pressIcon: {
          type: String,
          default:
            "Tik op dit pictogram om de app op het beginscherm te starten.",
        },
        step1ChromeDesktop: {
        ...
        step1ChromeMobile: {
          name: { type: String, default: "Stap 1" },
          instruction: { type: String, default: "Tik op ‘Delen’ in het menu." },
        },
        step2ChromeMobile: {
          name: { type: String, default: "Stap 2" },
          instruction: {
            type: String,
            default: "Tik op ‘Toevoegen aan startscherm’.",
          },
        },
        step3ChromeMobile: {
          name: { type: String, default: "Stap 3" },
          instruction: { type: String, default: "Tik op ‘Toevoegen’." },
        },
        step1SafariMobile: {
          name: { type: String, default: "Stap 1" },
          instruction: { type: String, default: "Tik op ‘Delen’ in het menu." },
        ...
        newFeatures: { type: String, default: "Foutoplossingen" },
    ...
    hongKong: {
      chinese: {
        ...
        noPWASupport: {
          type: String,
          default:
            "您的浏览器不支持PWA应用安装，请继续在Chrome或Safari上进行！",
        },
        ...
        newFeatures: { type: String, default: "漏洞修复" },
    ...
    indonesia: {
      indonesian: {
        ...
        pressIcon: {
          type: String,
          default: "Ketuk ikon ini untuk meluncurkan aplikasi di layar utama.",
        },
        step1ChromeDesktop: {
        ...
        step1ChromeMobile: {
          name: { type: String, default: "Langkah 1" },
          instruction: { type: String, default: "Ketuk ‘Bagikan’ pada menu." },
        },
        step2ChromeMobile: {
          name: { type: String, default: "Langkah 2" },
          instruction: {
            type: String,
            default: "Ketuk ‘Tambahkan ke Layar Utama’.",
          },
        },
        step3ChromeMobile: {
          name: { type: String, default: "Langkah 3" },
          instruction: { type: String, default: "Ketuk ‘Tambahkan’." },
        },
        step1SafariMobile: {
          name: { type: String, default: "Langkah 1" },
          instruction: { type: String, default: "Ketuk ‘Bagikan’ pada menu." },
        ...
        verified: {
          type: String,
          default: "Peringkat dan ulasan diverifikasi",
        },
        ...
        newFeatures: { type: String, default: "Perbaikan bug" },
    ...
    malaysia: {
      malay: {
        ...
        pressIcon: {
          type: String,
          default: "Ketuk ikon ini untuk melancarkan aplikasi di Laman Utama.",
        },
        step1ChromeDesktop: {
          name: { type: String, default: "Langkah 1" },
          instruction: { type: String, default: "Klik ‘Pasang’ pada menu" },
        ...
        step1ChromeMobile: {
          name: { type: String, default: "Langkah 1" },
          instruction: { type: String, default: "Ketuk ‘Kongsi’ pada menu." },
        },
        step2ChromeMobile: {
          name: { type: String, default: "Langkah 2" },
          instruction: {
            type: String,
            default: "Ketuk ‘Tambahkan ke Skrin Utama’.",
          },
        },
        step3ChromeMobile: {
          name: { type: String, default: "Langkah 3" },
        ...
        newFeatures: { type: String, default: "Pembaikan pepijat" },
        icon: {
          type: String,
          default:
            "https://res.cloudinary.com/datkh2oxv/image/upload/v1731180508/dmt/background/favicon.svg",
    ...
    pakistan: {
      urdu: {
        ...
        step1SafariDesktop: {
          ...
          instruction: {
            type: String,
            default: "فہرست میں 'شیئر' پر کلک کریں",
          },
        },
        step2SafariDesktop: {
          name: { type: String, default: "مرحلہ 2" },
        ...
        available: {
          type: String,
          default: "یہ ایپ آپ کے آلہ کے لئے دستیاب ہے",
        },
        ...
        verified: {
          type: String,
          default: "درجات اور جائزے کی تصدیق کی گئی ہے",
        },
        ...
        newFeatures: { type: String, default: "بگ کی اصلاحات" },
    ...
    russia: {
      russian: {
        ...
        step1ChromeMobile: {
          ...
          instruction: {
            type: String,
            default: "Нажмите «Поделиться» в меню.",
          },
        },
        step2ChromeMobile: {
          name: { type: String, default: "Шаг 2" },
        ...
        newFeatures: { type: String, default: "Исправления ошибок" },
    ...
    senegal: {
      french: {
        ...
        newFeatures: { type: String, default: "Corrections de bogues" },
    ...
    southKorea: {
      korean: {
        ...
        step2ChromeMobile: {
          ...
          instruction: {
            type: String,
            default: "'홈 화면에 추가'를 누르세요.",
          },
        },
        step3ChromeMobile: {
          name: { type: String, default: "3단계" },
          instruction: { type: String, default: "'추가'를 누르세요." },
        },
        step1SafariMobile: {
          name: { type: String, default: "1단계" },
          instruction: {
        ...
        newFeatures: { type: String, default: "버그 수정" },
    ...
    turkey: {
      turkish: {
        ...
        newFeatures: { type: String, default: "Hata düzeltmeleri" },
    ...
    lithuania: {
      lithuanian: {
        isExist: { type: Boolean, default: false },
        open: { type: String, default: "Atidaryti" },
        noPWASupport: {
          type: String,
          default:
        ...
        step1ChromeDesktop: {
          ...
          instruction: {
            type: String,
            default: "Meniu spustelėkite „Įdiegti“",
          },
        },
        step2ChromeDesktop: {
          name: {
        ...
        step1SafariDesktop: {
          ...
          instruction: {
            type: String,
            default: "Meniu spustelėkite „Dalintis“",
          },
        },
        step2SafariDesktop: {
          name: {
          ...
          instruction: {
            type: String,
            default: "Spustelėkite „Pridėti į Dock“",
          },
        },
        step3SafariDesktop: {
          name: {
        ...
        step1ChromeMobile: {
          ...
          instruction: {
            type: String,
            default: "Meniu pasirinkite „Dalintis“",
          },
        },
        step2ChromeMobile: {
          name: {
          ...
          instruction: {
            type: String,
            default: "Paspauskite „Pridėti į pagrindinį ekraną“",
          },
        },
        step3ChromeMobile: {
          name: {
        ...
        greeting: {
          type: String,
          default: "Sveiki, sveiki atvykę!",
        },
        wait: {
          type: String,
          default: "Prašome palaukti",
        },
        proceed: {
          type: String,
          default: "Tęsti",
        },
        description: { type: String, default: "Testas 1" },
        containsAds: {
          type: String,
          default: "Yra skelbimų",
        },
        inAppPurchases: {
          type: String,
          default: "Programėlės vidiniai pirkimai",
        },
        headerReviews: {
          type: String,
          default: "3.2T atsiliepimai",
        },
        hundredPlus: {
          type: String,
          default: "100T+",
        ...
        ageRating: {
          type: String,
          default: "Vertinama kaip tinkama 18+",
        },
        install: {
          type: String,
          default: "Įdiegti",
        ...
        wishlist: {
          type: String,
          default: "Pridėti į norų sąrašą",
        },
        available: {
          type: String,
          default: "Ši programėlė pasiekiama jūsų įrenginiui",
        },
        aboutThisGame: {
          type: String,
          default: "Apie šią programėlę",
        },
        about: {
          type: String,
          default:
            "1xBet yra įdomi mobili kazino programėlė, kuri įtraukia į įvairius unikalius žaidimus. Prisijunkite šiandien ir gaukite išskirtinę registracijos premiją pradėti savo pelno paieškas.",
        },
        updatedOn: { type: String, default: "Atnaujinta" },
        updatedDate: { type: String, default: "2023 m. rugsėjo 30 d." },
        casino: { type: String, default: "Kazino" },
        dataSafety: { type: String, default: "Duomenų saugumas" },
        safety: {
          type: String,
          default:
        ...
        noInformation: { type: String, default: "Informacijos nėra" },
        seeDetails: { type: String, default: "Žiūrėti detales" },
        ratingsAndReviews: {
          type: String,
          default: "Įvertinimai ir apžvalgos",
        },
        verified: {
          type: String,
          default: "Įvertinimai ir apžvalgos patikrinti",
        },
        phone: { type: String, default: "Telefonas" },
        tV: { type: String, default: "TV" },
        chromebook: { type: String, default: "Chromebook" },
        tablet: { type: String, default: "Planšetinis kompiuteris" },
        reviews: { type: String, default: "atsiliepimai" },
        fourPointThree: { type: String, default: "4.8" },
        fifteenM: { type: String, default: "15.5M" },
        reviewObject: [
          {
        ...
        helpful: {
          type: String,
          default: "žmonių ši apžvalga buvo naudinga",
        },
        allReviews: { type: String, default: "Žiūrėti visas apžvalgas" },
        whatsNew: { type: String, default: "Kas naujo" },
        findHelpful: { type: String, default: "Ar radote tai naudinga?" },
        yes: { type: String, default: "Taip" },
        no: { type: String, default: "Ne" },
        contact: { type: String, default: "Kūrėjo kontaktai" },
        newFeatures: { type: String, default: "Klaidų taisymai" },
