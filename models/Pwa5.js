...
const pwaSchema = new mongoose.Schema(
  {
    ...
    chinese: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "2024年1月22日" },
        review: {
          type: String,
          default: "应用程序运行良好，提款快速。我建议大家下载这个应用程序",
        },
        helpful: { type: String, default: "13人觉得此评论有帮助" },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "2024年1月21日" },
        review: {
          type: String,
          default:
            "等了10分钟才把钱提到我的账户，开始担心了，写信给客服后，钱立刻到了。好应用程序",
        },
        helpful: { type: String, default: "4人觉得此评论有帮助" },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "2024年1月18日" },
        review: {
          type: String,
          default: "1xBet 是一个很棒的应用程序。我推荐给大家",
        },
        helpful: { type: String, default: "2人觉得此评论有帮助" },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "2024年1月12日" },
        review: { type: String, default: "刚提了1400美元，强烈推荐！" },
        helpful: { type: String, default: "185人觉得此评论有帮助" },
      },
    ...
    dutch: {
      ...
      review1: {
        ...
        review: {
          type: String,
          default:
            "Applicatie werkt erg goed en geld opnemen gaat snel. Ik raad iedereen aan om deze applicatie te downloaden",
        },
        helpful: {
          type: String,
          default: "13 mensen vonden deze recensie nuttig",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        ...
        review: {
          type: String,
          default:
            "10 minuten gewacht om geld naar mijn rekening op te nemen, begon me zorgen te maken, schreef naar ondersteuning en het geld kwam meteen. Goede applicatie",
        },
        helpful: {
          type: String,
          default: "4 mensen vonden deze recensie nuttig",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        ...
        review: {
          type: String,
          default: "1xBet is een geweldige app. Ik raad het iedereen aan",
        },
        helpful: {
          type: String,
          default: "2 mensen vonden deze recensie nuttig",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        ...
        review: {
          type: String,
          default: "Net 1400$ opgenomen, zeker aanbevolen!",
        },
        helpful: {
          type: String,
          default: "185 mensen vonden deze recensie nuttig",
        },
      },
    ...
    english: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "January 22, 2024" },
        review: {
          type: String,
          default:
            "Application works very well and withdraws money quickly. I advise everyone to download this application",
        },
        helpful: {
          type: String,
          default: "13 people found this review helpful",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "January 21, 2024" },
        review: {
          type: String,
          default:
        ...
        helpful: {
          type: String,
          default: "4 people found this review helpful",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "January 18, 2024" },
        review: {
          type: String,
          default: "1xBet is a great app. I recommend it to everyone",
        },
        helpful: {
          type: String,
          default: "2 people found this review helpful",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "January 12, 2024" },
        review: {
          type: String,
          default: "Just withdrew 1400$, definitely recommend!",
        },
        helpful: {
          type: String,
          default: "185 people found this review helpful",
        },
      },
    ...
    french: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "22 janvier 2024" },
        review: {
          type: String,
          default:
            "L'application fonctionne très bien et retire l'argent rapidement. Je conseille à tout le monde de télécharger cette application",
        },
        helpful: {
          type: String,
          default: "13 personnes ont trouvé cet avis utile",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "21 janvier 2024" },
        review: {
          type: String,
          default:
            "J'ai attendu 10 minutes pour retirer de l'argent sur mon compte, j'ai commencé à m'inquiéter, j'ai écrit au support et l'argent est arrivé immédiatement. Bonne application",
        },
        helpful: {
          type: String,
          default: "4 personnes ont trouvé cet avis utile",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "18 janvier 2024" },
        review: {
          type: String,
          default:
            "1xBet est une excellente application. Je la recommande à tout le monde",
        },
        helpful: {
          type: String,
          default: "2 personnes ont trouvé cet avis utile",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "12 janvier 2024" },
        review: {
          type: String,
          default: "Je viens de retirer 1400$, je recommande vivement !",
        },
        helpful: {
          type: String,
          default: "185 personnes ont trouvé cet avis utile",
        },
      },
    ...
    indonesian: {
      ...
      review1: {
        ...
        review: {
          type: String,
          default:
            "Aplikasi berfungsi dengan baik dan menarik uang dengan cepat. Saya sarankan semua orang mengunduh aplikasi ini",
        },
        helpful: {
          type: String,
          default: "13 orang menganggap ulasan ini bermanfaat",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        ...
        review: {
          type: String,
          default:
            "Menunggu 10 menit untuk menarik uang ke akun saya, mulai khawatir, menulis ke dukungan dan uang datang segera. Aplikasi yang bagus",
        },
        helpful: {
          type: String,
          default: "4 orang menganggap ulasan ini bermanfaat",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        ...
        review: {
          type: String,
          default:
            "1xBet adalah aplikasi yang bagus. Saya merekomendasikan untuk semua orang",
        },
        helpful: {
          type: String,
          default: "2 orang menganggap ulasan ini bermanfaat",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        ...
        review: {
          type: String,
          default: "Baru saja menarik 1400$, sangat direkomendasikan!",
        },
        helpful: {
          type: String,
          default: "185 orang menganggap ulasan ini bermanfaat",
        },
      },
    ...
    urdu: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "22 جنوری 2024" },
        review: {
          type: String,
          default:
            "ایپلیکیشن بہت اچھا کام کرتی ہے اور جلدی پیسے نکالتی ہے۔ میں ہر ایک کو یہ ایپلیکیشن ڈاؤن لوڈ کرنے کا مشورہ دیتا ہوں",
        },
        helpful: { type: String, default: "13 لوگوں نے اس جائزے کو مفید پایا" },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "21 جنوری 2024" },
        review: {
          type: String,
          default:
            "اپنے اکاؤنٹ میں پیسے نکالنے کے لئے 10 منٹ کا انتظار کیا، فکر مند ہو گیا، سپورٹ کو لکھا اور فوراً پیسے آ گئے۔ اچھی ایپلیکیشن",
        },
        helpful: { type: String, default: "4 لوگوں نے اس جائزے کو مفید پایا" },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "18 جنوری 2024" },
        review: {
          type: String,
          default:
            "1xBet ایک بہترین ایپ ہے۔ میں ہر ایک کو اس کی سفارش کرتا ہوں",
        },
        helpful: { type: String, default: "2 لوگوں نے اس جائزے کو مفید پایا" },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "12 جنوری 2024" },
        review: {
          type: String,
          default: "1400$ نکالے، یقینی طور پر سفارش کرتا ہوں!",
        },
        helpful: {
          type: String,
          default: "185 لوگوں نے اس جائزے کو مفید پایا",
        },
      },
    ...
    korean: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "2024년 1월 22일" },
        review: {
          type: String,
          default:
            "앱이 매우 잘 작동하며 돈을 빨리 인출합니다. 모든 사람에게 이 앱을 다운로드하도록 권장합니다",
        },
        helpful: {
          type: String,
          default: "13명이 이 리뷰를 유용하다고 평가했습니다",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "2024년 1월 21일" },
        review: {
          type: String,
          default:
            "계정으로 돈을 인출하려고 10분을 기다렸고 걱정하기 시작했습니다. 지원팀에 연락했고 즉시 돈이 들어왔습니다. 좋은 앱입니다",
        },
        helpful: {
          type: String,
          default: "4명이 이 리뷰를 유용하다고 평가했습니다",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "2024년 1월 18일" },
        review: {
          type: String,
          default: "1xBet은 훌륭한 앱입니다. 모두에게 추천합니다",
        },
        helpful: {
          type: String,
          default: "2명이 이 리뷰를 유용하다고 평가했습니다",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "2024년 1월 12일" },
        review: {
          type: String,
          default: "방금 1400$을 인출했습니다. 강력히 추천합니다!",
        },
        helpful: {
          type: String,
          default: "185명이 이 리뷰를 유용하다고 평가했습니다",
        },
      },
    ...
    russian: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "22 января 2024" },
        review: {
          type: String,
          default:
            "Приложение работает очень хорошо, вывод денег быстрый. Рекомендую всем скачать это приложение",
        },
        helpful: {
          type: String,
          default: "13 человек нашли этот отзыв полезным",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "21 января 2024" },
        review: {
          type: String,
          default:
            "Ждал 10 минут для вывода денег на счет, начал волноваться, написал в поддержку и деньги пришли сразу. Хорошее приложение",
        },
        helpful: {
          type: String,
          default: "4 человека нашли этот отзыв полезным",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "18 января 2024" },
        review: {
          type: String,
          default: "1xBet - отличное приложение. Рекомендую всем",
        },
        helpful: {
          type: String,
          default: "2 человека нашли этот отзыв полезным",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "12 января 2024" },
        review: {
          type: String,
          default: "Только что вывел 1400$, рекомендую!",
        },
        helpful: {
          type: String,
          default: "185 человек нашли этот отзыв полезным",
        },
      },
    ...
    turkish: {
      ...
      review1: {
        name: { type: String, default: "samurai" },
        date: { type: String, default: "22 Ocak 2024" },
        review: {
          type: String,
          default:
            "Uygulama çok iyi çalışıyor ve para çekme işlemi hızlı. Herkese bu uygulamayı indirmesini tavsiye ederim",
        },
        helpful: { type: String, default: "13 kişi bu yorumu yararlı buldu" },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        date: { type: String, default: "21 Ocak 2024" },
        review: {
          type: String,
          default:
            "Hesabıma para çekmek için 10 dakika bekledim, endişelenmeye başladım, destek ekibine yazdım ve para hemen geldi. İyi bir uygulama",
        },
        helpful: { type: String, default: "4 kişi bu yorumu yararlı buldu" },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        date: { type: String, default: "18 Ocak 2024" },
        review: {
          type: String,
          default: "1xBet harika bir uygulama. Herkese tavsiye ederim",
        },
        helpful: { type: String, default: "2 kişi bu yorumu yararlı buldu" },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        date: { type: String, default: "12 Ocak 2024" },
        review: {
          type: String,
          default: "1400$ çektim, kesinlikle tavsiye ederim!",
        },
        helpful: { type: String, default: "185 kişi bu yorumu yararlı buldu" },
      },
    ...
    malay: {
      ...
      review1: {
        ...
        review: {
          type: String,
          default:
            "Aplikasi berfungsi dengan baik dan menarik wang dengan cepat. Saya nasihatkan semua orang untuk muat turun aplikasi ini",
        },
        helpful: {
          type: String,
          default: "13 orang mendapati ulasan ini berguna",
        },
      },
      review2: {
        name: { type: String, default: "Bracken322" },
        ...
        helpful: {
          type: String,
          default: "4 orang mendapati ulasan ini berguna",
        },
      },
      review3: {
        name: { type: String, default: "Jack Sparrow" },
        ...
        helpful: {
          type: String,
          default: "2 orang mendapati ulasan ini berguna",
        },
      },
      review4: {
        name: { type: String, default: "Sheff816" },
        ...
        review: {
          type: String,
          default: "Baru sahaja menarik 1400$, sangat disyorkan!",
        },
        helpful: {
          type: String,
          default: "185 orang mendapati ulasan ini berguna",
        },
      },
      allReviews: { type: String, default: "Lihat semua ulasan" },
      whatsNew: { type: String, default: "Apa yang baru" },
